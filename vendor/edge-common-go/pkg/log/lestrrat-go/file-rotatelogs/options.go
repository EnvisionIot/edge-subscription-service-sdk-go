...
import (
	"edge-common-go/pkg/log/lestrrat-go/file-rotatelogs/internal/option"
	"time"
)
...
const (
	...
	optkeyMaxKeepFile   = "max-keep-file-count"
	optkeyMaxFileSize   = "max-file-size"
	optkeyContract      = "."
	optkeySuffix        = "*"
	msgChanLimit        = 50
)
...
func WithMaxFileKeepCount(n int) Option {
	return option.New(optkeyMaxKeepFile, n)
}

func WithMaxFileSize(n int64) Option {
	return option.New(optkeyMaxFileSize, n)
}
